import '../passcode_screen/widgets/passcode_item_widget.dart';
...
class PasscodeScreen extends GetWidget<PasscodeController> {
  @override
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller
                        .passcodeModelObj.value.passcodeItemList.value.length,
                    itemBuilder: (context, index) {
                      PasscodeItemModel model = controller
                          .passcodeModelObj.value.passcodeItemList.value[index];
                      return PasscodeItemWidget(
                        model,
                      );
                    },
                  ),
