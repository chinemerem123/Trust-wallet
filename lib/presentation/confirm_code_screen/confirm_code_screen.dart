import '../confirm_code_screen/widgets/confirm_code1_item_widget.dart';
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.confirmCodeModelObj.value
                        .confirmCode1ItemList.value.length,
                    itemBuilder: (context, index) {
                      ConfirmCode1ItemModel model = controller
                          .confirmCodeModelObj
                          .value
                          .confirmCode1ItemList
                          .value[index];
                      return ConfirmCode1ItemWidget(
                        model,
                      );
                    },
                  ),
